...
int main() {
    ...
    try
    {
        ...
        std::sort(begin(ip_pool), end(ip_pool), comp4);
        ...
        // std::cout << "---------" << std::endl << "NOW: only when 1st byte = 1" << std::endl << "---------" << std::endl;
        ...
        // std::cout << "---------" << std::endl << "NOW: 1st byte = 46, 2nd byte = 70" << std::endl << "---------" << std::endl;
        ...
        // std::cout << "---------" << std::endl << "NOW: any byte = 46" << std::endl << "---------" << std::endl;
